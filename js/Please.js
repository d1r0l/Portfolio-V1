...
!(function (e, r, a) {
  ...
  function e() {
    ...
    function n(e) {
      var r = F.HSV_to_RGB(e),
        a = (299 * r.r + 587 * r.g + 114 * r.b) / 1e3
    ...
    var F = {},
      ...
      c = { scheme_type: 'analogous', format: 'hex' },
      h = { golden: !1, format: 'hex' }
    return (
      (F.NAME_to_HEX = function (e) {
        return (
          (e = e.toLowerCase()),
          e in s ? s[e] : (console.error('Color name not recognized.'), void 0)
        )
      }),
      ...
      (F.RGB_to_HSV = function (e) {
        var r = e.r / 255,
          ...
          t = 0,
          l = 0,
          F = Math.min(r, Math.min(a, o)),
          s = Math.max(r, Math.max(a, o))
        if (F === s) return (l = F), { h: 0, s: 0, v: l }
        var i = r === F ? a - o : o === F ? r - a : o - r,
          u = r === F ? 3 : o === F ? 1 : 5
        return (
          (n = 60 * (u - i / (s - F))),
          (t = (s - F) / s),
      ...
      (F.make_color = function (n) {
        ...
        var g = null
        'string' == typeof c.seed && (g = new l(c.seed)),
          c.base_color.length > 0 &&
            (h = c.base_color.match(/^#?([0-9a-f]{3})([0-9a-f]{3})?$/i)
              ? F.HEX_to_HSV(c.base_color)
              : F.NAME_to_HSV(c.base_color))
        for (var m = 0; m < c.colors_returned; m++) {
          var f,
            ...
            p = e(0, 360, g)
          null !== h
            ? ((f = a(e(h.h - 5, h.h + 5, g), 0, 360)),
              (E = 0 === h.s ? 0 : r(0.4, 0.85, g)),
              (b = r(0.4, 0.85, g)),
              s.push({ h: f, s: E, v: b }))
            : ((f =
                c.greyscale === !0 || c.grayscale === !0
                  ? 0
                  : c.golden === !0
                  ? (p + p / i) % 360
                  : null === c.hue || c.full_random === !0
                  ? p
                  : a(c.hue, 0, 360)),
              (E =
                c.greyscale === !0 || c.grayscale === !0
      ...
      (F.make_contrast = function (e, r) {
        ...
        return (
          'dark' === d
            ? (m = a(e.v - 0.25, 0, 1))
            : 'light' === d && (m = a(e.v + 0.25, 0, 1)),
          (u = [{ h: c, s: e.s, v: m }]),
          o(l.format.toLowerCase(), u),
          u[0]
        )
      }),
      F
